...
SECRET_KEY = 'django-insecure-=!84uy(y%9t0ei5u@@3y5e=v+^gipg1t41v1+16+z(d8%lh^_u'
...
DATABASES = {
    'default': {
        ...
        'HOST': 'localhost',   # Pode ser 'localhost' ou o endereço IP do seu servidor PostgreSQL
